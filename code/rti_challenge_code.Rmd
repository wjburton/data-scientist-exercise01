...
###Step 2: Exploratory Analysis <br>
**Summary**
...
**Univariate Distribution Interesting Observations:** <br>

* It appears that within a household, mainly the males are filling out the form. This is evident in the relationship and sex variables. In the variable relationship, recording 'husband' is nearly 4 times as common as 'wife'. Within the variable sex, there are nearly 2 times as many men as women. This is not representative of the entire united states because we know the estimated distribution is 51% females to 49% males.

* The never married proportion appears very high because the census is at the household level. The number of 'married' people should be double the frequency since only one spouse would respond to the survey

* For some odd reason, the max reported capital gain is $99,999 and that was repeated 244 times. Maybe this is the max the value is allowed to be? Or the range on the census stops at $99,999?
